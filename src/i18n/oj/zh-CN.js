export const m = {
  ...
  Teacher: '教师',
  InviteCode: '邀请码',
  InvalidInviteCode: 'this invitation code is invalid',
  Already_Registed: '已经注册？立即登录!',
  The_username_already_exists: 'this username already exists',
  The_email_already_exists: 'this email already exists',
